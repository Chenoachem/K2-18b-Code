...
df = pd.read_pickle("unique_signals_08_14_nozerodrift.pkl")
...
df_clean.to_pickle("unique_signals_08_14_nozerodrift_cleaned.pkl")

# Optional: Feedback
print(f"Original: {len(df)} rows")
print(f"Filtered: {len(df_clean)} rows")
print(f"Saved cleaned result to 'unique_signals_08_14_nozerodrift_cleaned.pkl'")
