...
df_k218b=pd.read_pickle("k2-18b-sband_vla.pkl")
df_other=pd.read_pickle("other-sband.pkl")
...
df_unique_rows.to_pickle("k218b_unique_signals_s-band_2.pkl") #write out a new pickle file
