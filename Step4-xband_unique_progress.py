...
df_k218b=pd.read_pickle("k218b_xband_realdrift_realsnr_cleaned.pkl")
df_other=pd.read_pickle("Other_xband_realdrift_realsnr.pkl")
...
df_unique_rows.to_pickle("k218b_unique_signals_s-band.pkl") #write out a new pickle file
